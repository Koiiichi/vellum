...
MAILER_SEND_RETRY_ATTEMPTS = _get_int("MAILER_SEND_RETRY_ATTEMPTS", 3)
MAILER_RETRY_BASE_DELAY_S = _get_int("MAILER_RETRY_BASE_DELAY_S", 2)
MAILER_MAX_RETRY_DELAY_S = _get_int("MAILER_MAX_RETRY_DELAY_S", 900)
